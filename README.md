...
![screenshot placeholder](https://placehold.co/900x500?text=Strava+Mapper)
...
- **Stats panel** — total activities, distance, elevation, moving time, longest activity, and most elevation gain
...
│   ├── map.html             # Map + stats page
│   ├── css/style.css
│   ├── js/
│   │   ├── setup.js
│   │   └── map.js           # Leaflet map, polyline decoder, stats
...
├── scripts/
│   └── copy-leaflet.js      # Copies leaflet dist → public/leaflet/
